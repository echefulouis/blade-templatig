...
<div class="super_container">
			...
			<div class="row">
				<div class="col">
					<div class="header_content d-flex flex-row align-items-center justify-content-start">
						...
						<div class="logo"><a href="{{route('index')}}">Travello</a></div>
							<nav class="main_nav">
	...
	<div class="menu">
		<div class="menu_header d-flex flex-row align-items-center justify-content-start">
			<div class="menu_logo"><a href="{{route('index')}}">Travello</a></div>
	...
	<div class="intro">
		<div class="intro_background" style="background-image:url({{asset('images/intro.png')}})"></div>
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="intro_container">
						<div class="row">
							...
							<div class="col-lg-4 intro_col">
								...
								<div class="intro_icon"><img src="{{asset('images/beach.svg')}}" alt=""></div>
							...
							<div class="col-lg-4 intro_col">
								<div class="intro_item d-flex flex-row align-items-end justify-content-start">
								<div class="intro_icon"><img src="{{asset('images/wallet.svg')}}" alt=""></div>
									<div class="intro_content">
							...
							<div class="col-lg-4 intro_col">
								<div class="intro_item d-flex flex-row align-items-end justify-content-start">
								<div class="intro_icon"><img src="{{asset('images/suitcase.svg')}}" alt=""></div>
									<div class="intro_content">
			...
			<div class="row destinations_row">
				<div class="col">
					<div class="destinations_container item_grid">
						...
						<div class="destination item">
							<div class="destination_image">
								<img src="{{asset('images/destination_4.jpg')}}" alt="">
							</div>
							<div class="destination_content">
						...
						<div class="destination item">
							<div class="destination_image">
								<img src="{{asset('images/destination_5.jpg')}}" alt="">
							</div>
							<div class="destination_content">
						...
						<div class="destination item">
							<div class="destination_image">
								<img src="{{asset('images/destination_6.jpg')}}" alt="">
							</div>
							<div class="destination_content">
	...
	<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="{{asset('images/testimonials.jpg')}}" data-speed="0.8"></div>
		<div class="container">
			<div class="row">
				<div class="col text-center">
					<div class="section_subtitle">simply amazing places</div>
	...
	<div class="news" id="news">
		<div class="container">
			<div class="row">
				<div class="col-xl-8">
					<div class="news_container">
						...
						<div class="news_post d-flex flex-md-row flex-column align-items-start justify-content-start">
							<div class="news_post_image"><img src="{{asset('images/news_1.jpg')}}" alt=""></div>
						...
						<!-- News Post -->
						<div class="news_post d-flex flex-md-row flex-column align-items-start justify-content-start">
							<div class="news_post_image"><img src="{{asset('images/news_2.jpg')}}" alt=""></div>
							<div class="news_post_content">
								<div class="news_post_date d-flex flex-row align-items-end justify-content-start">
									<div>01</div>
									<div>june</div>
						...
						<!-- News Post -->
						<div class="news_post d-flex flex-md-row flex-column align-items-start justify-content-start">
							<div class="news_post_image"><img src="{{asset('images/news_3.jpg')}}" alt=""></div>
							<div class="news_post_content">
								<div class="news_post_date d-flex flex-row align-items-end justify-content-start">
									<div>29</div>
									<div>may</div>
				...
				<div class="col-xl-4">
					<div class="travello">
						<div class="background_image" style="background-image:url({{asset('images/travello.jpg')}}"></div>
